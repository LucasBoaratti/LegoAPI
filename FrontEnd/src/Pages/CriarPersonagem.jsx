import css from "../Styles/CriarPersonagem.module.css";
import { z } from "zod";
...
export function CriarPersonagem() {
    ...
    async function criar_personagem(data) {
        const dados = { //Pegando todos os dados da API
            ...data,
        }

        try {
            await axios.post("http://127.0.0.1:8000/api/v1/legos/", dados); //Enviando os dados para a API de legos via POST
            ...
            console.error("Erro ao criar personagem: ", error.response?.data || error.mensage); //Mensagem de erro que aparece exatamente o erro em algum campo do formulário
        }
    }
    ...
    return (
        <main className={css.conteudoPricipal}>
            <section className={css.formulario}>
                ...
                <form onSubmit={handleSubmit(criar_personagem)}>
